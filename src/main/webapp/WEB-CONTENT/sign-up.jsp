                                ...
                                <form class="mx-1 mx-md-4" name="register" method="post">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <div class="row">
                                                <div class="col">
                                                    <input name="firstName" type="text" id="form3Example1c" class="form-control" placeholder="First Name" />
                                                    <label class="form-label" for="form3Example1c">First Name</label>
                                                </div>
                                                <div class="col">
                                                    <input name="lastName" type="text" id="form3Example2c" class="form-control" placeholder="Last Name" />
